...
model_path = 'skincare_modell.h5'  # Perbarui dengan path yang benar
...
# Aplikasi Streamlit ===========================================================================================================
# Tambahkan CSS di awal aplikasi Streamlit
st.markdown("""
    <style>
    ...
    .st-chat-message-assistant {
        background-color: #f8bbd0; /* Pink muda lebih terang */
        padding: 10px;
        border-radius: 10px;
        margin-bottom: 10px;
    }
    .st-chat-message {
        max-width: 70%; /* Untuk mengontrol lebar pesan */
    }
    </style>
